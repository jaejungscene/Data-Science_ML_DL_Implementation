...
def test():
    ...
    test_acc_graph.append(Acc)

    print('# TEST : Loss: ({:.4f}) | Acc: ({:.2f}%) ({}/{})'
      .format(test_loss/(batch_idx+1), Acc, correct, total))
...
plt.savefig('/home/ljj0512/private/workspace/images/tarin_loss_graph.jpg')
plt.close()

plt.plot(test_loss_graph)
plt.title('test loss')
plt.savefig('/home/ljj0512/private/workspace/images/test_loss_graph.jpg')
plt.close()
